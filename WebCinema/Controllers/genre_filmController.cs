...
namespace WebCinema.Controllers
{
    public class genre_filmController : Controller
    {
        ...
        {
            var genre_film = new ManagerGenreFilm().GetAllGenreFilm();
        ...
        public ActionResult Details(int? id)
        {
            ...
            genre_film genre_film = new ManagerGenreFilm().GetGenreFilm(id);
            if (genre_film == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.genre_id = new SelectList(new ManagerGenre().GetAllGenre(), "id", "genre1");
            return View();
        }
